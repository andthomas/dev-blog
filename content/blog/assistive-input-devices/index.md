...
![A head tracking device user wearing a reflective dot in front of their tracking camera](https://i.imgur.com/tXVUJfH.png)
...
![A PC user has their gaze tracking device mounted at the base of their monitor to track their eye movements](https://i.imgur.com/GXGZELE.png)
...
![A head pointer user uses their device to control a custom computer interface](https://i.imgur.com/bZnAxTu.png)
...
![A young legend demonstrating how a jelly bean switch is used](https://imgur.com/0KPsb4r.png)
...
![A user with a sip and puff held in the side of his mouth](https://imgur.com/htkMaXT.png)
...
![A string switch being pulled by a users hand](https://i.imgur.com/HbRzqYI.png)

### Pillow switch

A pillow switch provides a soft surface to activate a switch with a users head or cheek. They can be mounted to a users wheelchair and provide auditory and tactile feedback. Although I've never used a pillow switch personally, I would imagine this switch to cause discomfort after extended use from the repetitive head/neck movement. Aside from that, the large target area means users with limited motor skill in their head/neck can use this switch more easily than a device that relies on steady head/neck control.

![A user demonstrates how a pillow switch can be mounted to the side of their chair and comfortably pressed with their head](https://i.imgur.com/bJIwmMO.png)
...
![A pal pad switch being used to operate an iPad](https://i.imgur.com/Ly860yg.png)
...
![A big keyboard with USB cable](https://imgur.com/H4JmAWT.png)
...
![And orbiTouch keyboard being moved to the left to type the letter A](https://imgur.com/9s3fi9X.png)

The orbiTouch has obvious accessibility benefits but also does not compromise heavily on effeciency of use unlike some other pieces of hardware in this post. According to orbiTouch, on average, users reach typing speeds of 20-30 wpm after 15 hours of use. 
...
![A keyboard with a keyguard fitted over the top](https://imgur.com/A5T0kdc.png)
...
![A user with a slide board fitted over the top of an iPad](https://imgur.com/5rzOTqb.png)
